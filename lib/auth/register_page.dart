...
import 'package:coffee_shop_app/util/progressbar_dialog.dart';
...
class RegisterScreenPageWidget extends StatefulWidget {
  ...
  @override
  _RegisterScreenPageWidgetState createState() =>
      _RegisterScreenPageWidgetState();
}

class _RegisterScreenPageWidgetState extends State<RegisterScreenPageWidget>
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: kColorGrey, shape: BoxShape.circle),
...
//                          Navigator.pushReplacementNamed(context, OTPPagee,arguments: numberPhoneController.text);
  ...
  Widget decideImageView() {
    if (RegisterScreenPageWidget.image == null) {
      ...
      return Container(
        decoration: BoxDecoration(color: kColorGrey, shape: BoxShape.circle),
        child: ClipOval(
          child: Image.file(
