...
import 'package:coffee_shop_app/providers/bill_provider.dart';
          ...
          return billProvider.isLoading
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return billProvider.listBill.length == 0
                        ? Text("a")
                        : Padding(
                            padding:
                                EdgeInsets.only(bottom: getScreenHeight(15)),
                            child: InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
