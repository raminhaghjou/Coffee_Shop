            ...
            Expanded(
              child: Padding(
                padding: EdgeInsets.only(
                    top: getScreenHeight(20), bottom: getScreenHeight(40)),
                child: ContainerCard(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "\$${bill.totalBill}",
                            style: TextStyle(fontSize: getScreenWith(20)),
                          )
                        ],
                      )
                    ],
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Số Lượng: $quantity",
                style:
                    TextStyle(color: Colors.grey, fontSize: getScreenWith(10)),
              )
            ],
          ),
        ),
