...
class DialogEdit extends StatelessWidget {
  ...
  const DialogEdit(
      {Key key, this.email, this.userName, this.phoneNumber, this.uid})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ProfileProvider>(
      create: (BuildContext context) => ProfileProvider(),
      child: DialogEditWidget(
        email: email,
        userName: userName,
              ...
              child: RaisedButton(
                onPressed: () {
                  data.updateInformation(
                      uid, userNameController.text, phoneNumberController.text);
