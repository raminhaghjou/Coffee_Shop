...
import 'package:coffee_shop_app/models/store.dart';
import 'package:coffee_shop_app/providers/detail_store_provider.dart';
import 'package:coffee_shop_app/shared/containercard.dart';
...
//    Provider.of<DetailStoreProvider>(context,listen: true).checkOpenCloseTime(store.closeTime,store.opentTime);
    Provider.of<DetailStoreProvider>(context, listen: false)
        .convertLatLnToLocation(store.latitude, store.longitude);
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            ...
                            left: getScreenWith(15),
                            right: getScreenWith(15)),
                        child: Align(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                _buildInforAddress(
                                    value.address, Icons.location_on),
                                const SizedBox(
                                  height: 10,
                                ),
                                _buildInforAddress(
                                    "${value.km.toString()} km (Current location)",
                                    Icons.adjust),
                                const SizedBox(
                                  height: 10,
                                ),
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                      "${store.opentTime + "-" + store.closeTime}"),
                                ],
                              )
                            ],
                          ),
