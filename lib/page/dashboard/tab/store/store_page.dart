...
import 'package:coffee_shop_app/providers/store_provider.dart';
      ...
      builder: (BuildContext context, StoreProvider value, Widget child) {
        ...
        return Scaffold(
            floatingActionButton: FloatingActionButton(
              onPressed: () => goToLocation(value.locationData.latitude,
                  value.locationData.longitude, 13),
                  ...
                  child: Align(
                      ...
                      child: SizedBox(
                          ...
                          child: ListView(
                            ...
                            children: value.listStore
                                .map((e) => InkWell(
                                      onTap: () {
                                        goToLocation(
                                            e.latitude, e.longitude, 17);
                                      },
                                      child: Padding(
                                        padding:
