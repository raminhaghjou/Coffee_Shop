...
import 'package:coffee_shop_app/page/dashboard/tab/categories/my_bag_page.dart';
...
import 'package:coffee_shop_app/providers/detail_provider.dart';
import 'package:coffee_shop_app/util/const.dart';
import 'package:coffee_shop_app/util/router_path.dart';
import 'package:coffee_shop_app/util/showsnackbars.dart';
...
class DetailCategoriesFoodPageee extends StatelessWidget {
  final Menu menu;
  const DetailCategoriesFoodPageee({
    Key key,
    this.menu,
  }) : super(key: key);
  @override
...
class DetailCategoriesFoodPage extends StatefulWidget {
  ...
  @override
  _DetailCategoriesFoodPageState createState() =>
      _DetailCategoriesFoodPageState();
}
            ...
            children: <Widget>[
                ...
                child: Container(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(
                          left: getScreenWith(20),
                          right: getScreenWith(20),
                          top: getScreenHeight(40)),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildToolBar(Icons.arrow_back_ios, () {
              ...
              Align(
                ...
                child: Container(
                  width: double.infinity,
                  padding: EdgeInsets.only(
                      left: getScreenWith(20), top: getScreenHeight(30)),
