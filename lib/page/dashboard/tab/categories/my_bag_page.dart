...
import 'package:coffee_shop_app/util/dowloadimage.dart';
...
class MyBagPageWidget extends StatelessWidget {
  ...
  const MyBagPageWidget({Key key, this.listOrder, this.listOrderr})
      : super(key: key);
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Icon(Icons.shopping_cart, color: kColorGreen),
                ),
                const SizedBox(
                  width: 20,
                ),
