...
import 'package:coffee_shop_app/page/dashboard/tab/categories/cart_empty.dart';
...
class MyCartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: listCart.length == 0
          ? CartEmpty()
          : Stack(
              children: [
                Container(
                  padding: EdgeInsets.only(
                      left: getScreenWith(10),
                      right: getScreenWith(10),
                      top: getScreenHeight(50),
                      bottom: getScreenHeight(120)),
                  child: Column(
