...
class _DetailCategoriesPageState extends State<DetailCategoriesPage> {
  ...
  void initState() {
    ...
    Provider.of<CategoriesProvider>(context, listen: false)
        .getMenuByCategories(widget.idCategories);
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.pushNamed(context, DetailCategoriesFoodPagee,
              arguments: menu);
        },
        child: Row(
          ...
          children: <Widget>[
            ...
            Text(
              "\$${menu.price}",
              style: TextStyle(color: kColorGreen, fontWeight: FontWeight.bold),
            ),
          ],
        ),
      ),
