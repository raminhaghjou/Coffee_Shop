...
import 'package:coffee_shop_app/screens/check_out/delivery_details/delivery_details.dart';
import 'package:coffee_shop_app/widgets/single_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: ListTile(
        ...
        subtitle: Text(
          "\R ${reviewCartProvider.getTotalPrice()}",
          style: TextStyle(
