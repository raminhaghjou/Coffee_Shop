...
import 'package:coffee_shop_app/widgets/count.dart';
          ...
          child: Container(
            ...
            child: ListView(
              children: [
                ...
                Text("Coffee beverage is the end product obtained from roasted and ground Coffea plant seeds and, together with tea",
                  style: TextStyle(
                    fontSize: 16,
                    color: textColor,
                  ),
